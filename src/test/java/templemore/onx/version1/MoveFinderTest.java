...
public class MoveFinderTest {
    ...
    public void testWinningHorizontalPositionFinder() {
        ...
        assert(finder.findBestPosition(grid, Token.nought).equals(new Position(0, 2)));
    }
    ...
    public void testWinningVerticalPositionFinder() {
        ...
        final MoveFinder finder = new MoveFinder(false);
        assert(finder.findBestPosition(grid, Token.nought).equals(new Position(2, 0)));
    }
    ...
    public void testBlockingHorizontalPositionFinder() {
        ...
        final MoveFinder finder = new MoveFinder(false);
        assert(finder.findBestPosition(grid, Token.cross).equals(new Position(0, 2)));
    }
    ...
    public void testBlockingVerticalPositionFinder() {
        ...
        final MoveFinder finder = new MoveFinder(false);
        assert(finder.findBestPosition(grid, Token.cross).equals(new Position(2, 0)));
    }
    ...
    public void testDoubleWinPositionFinder() {
        ...
        final MoveFinder finder = new MoveFinder(false);
        assert(finder.findBestPosition(grid, Token.nought).equals(new Position(1, 0)));
    }
    ...
    public void testDoubleBlockPositionFinder() {
        ...
        final MoveFinder finder = new MoveFinder(false);
        assert(finder.findBestPosition(grid, Token.cross).equals(new Position(1, 0)));
    }
    ...
    public void testMiddlePositionSelectedIfOnDoubleEmptyLine() {
        ...
        final MoveFinder finder = new MoveFinder(false);
        assert(finder.findBestPosition(grid, Token.nought).equals(new Position(1, 1)));
    }
    ...
    public void testMostSuitablePositionSelectedIfOnEmptyLine() {
        ...
        final MoveFinder finder = new MoveFinder(false);
        assert(finder.findBestPosition(grid, Token.nought).equals(new Position(0, 0)));
    }
